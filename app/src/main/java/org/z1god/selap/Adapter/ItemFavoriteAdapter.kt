...
class ItemFavoriteAdapter(val listFavorite : ArrayList<ItemLapanganModel>) : RecyclerView.Adapter<ItemFavoriteAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(view : View) : RecyclerView.ViewHolder(view) {
        ...
        val image = view.findViewById<ImageView>(R.id.iv_favorite)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val item = listFavorite.get(position)
